...
- RTE sanitization: `HtmlSanitizerService` default profile allows safe figures, captions, images, attachment links, tables and constrained media iframes with explicit RTE `data-*` attributes.
