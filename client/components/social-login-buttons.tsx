    ...
    <div className="space-y-2">
      {PROVIDERS.map((p) => (
        <button
          ...
          className="flex w-full items-center justify-center gap-2.5 rounded-xl border border-input bg-background px-4 py-2.5 text-sm font-medium transition-colors hover:bg-accent disabled:opacity-60"
        >
          {loading === p.id ? (
