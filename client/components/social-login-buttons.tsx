    ...
    <div className="space-y-2">
      {PROVIDERS.map((p) => (
        <button
          ...
          className="border-input bg-background hover:bg-accent flex w-full items-center justify-center gap-2.5 rounded-xl border px-4 py-2.5 text-sm font-medium transition-colors disabled:opacity-60"
        >
          {loading === p.id ? (
