...
const layoutContainerStyles: Record<string, string> = {
  ...
  'three-col': 'mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-3 gap-8',
};
...
export function SectionRenderer({
  ...
  const sectionPadding = layout === 'flush' ? '' : (sectionPaddingStyles[padding] ?? 'py-12');
