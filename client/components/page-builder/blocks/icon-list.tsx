...
function BlockIcon({ name, color }: { name?: string; color?: string }) {
  const iconMap: Record<string, string> = {
    check: "✓", star: "★", bolt: "⚡", heart: "♥", shield: "🛡", lock: "🔒",
    truck: "🚚", clock: "⏱", globe: "🌍", phone: "📞", mail: "✉", users: "👥",
    chart: "📊", rocket: "🚀", leaf: "🍃", sun: "☀", moon: "🌙", zap: "⚡",
    award: "🏆", gift: "🎁", tag: "🏷", settings: "⚙", code: "💻",
    camera: "📷", music: "🎵", video: "🎬", file: "📄", folder: "📁",
  };
