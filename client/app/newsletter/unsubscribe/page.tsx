...
const i18n = {
    en: {
        ...
        errorToken:
            'Could not process your unsubscribe request. The link may be invalid.',
    },
    pl: {
        title: 'Wypisz się',
        ...
        successBody:
            'Zostałeś/aś usunięty/a z naszej listy. Szkoda, że odchodzisz!',
        processing: 'Przetwarzanie żądania…',
        errorDefault: 'Nie można wypisać. Spróbuj ponownie.',
        errorToken:
            'Nie można przetworzyć żądania. Link może być nieprawidłowy.',
    },
} as const;
