...
import { getStorefrontRoutes } from '@/api/cms';
...
const i18n = {
    ...
    pl: {
        ...
        failBody:
            'Ten link potwierdzający może być nieprawidłowy lub już użyty.',
        successTitle: 'Subskrypcja potwierdzona!',
        successBody:
            'Twoja subskrypcja newslettera została potwierdzona. Witaj na pokładzie!',
        shop: 'Zacznij zakupy',
    },
} as const;
...
export default async function NewsletterConfirmPage({
    ...
    const storefrontRoutes = await getStorefrontRoutes(locale);
