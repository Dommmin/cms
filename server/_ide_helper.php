...
namespace Grazulex\ApiIdempotency\Facades {
    ...
    class Idempotency {
        ...
        {
            /** @var \Grazulex\ApiIdempotency\IdempotencyManager $instance */
            return $instance->get($key, $scope);
        }
         ...
         * @static
         */
        public static function store($key, $response, $scope = null, $fingerprint = null, $request = null)
        {
            /** @var \Grazulex\ApiIdempotency\IdempotencyManager $instance */
            return $instance->store($key, $response, $scope, $fingerprint, $request);
        }
         ...
         * @static
         */
        public static function lock($key, $scope = null, $timeout = null)
        {
            /** @var \Grazulex\ApiIdempotency\IdempotencyManager $instance */
            return $instance->lock($key, $scope, $timeout);
        }
         ...
         * @static
         */
        public static function unlock($key, $scope = null)
        {
            /** @var \Grazulex\ApiIdempotency\IdempotencyManager $instance */
            return $instance->unlock($key, $scope);
        }
         ...
         * @static
         */
        public static function isLocked($key, $scope = null)
        {
            /** @var \Grazulex\ApiIdempotency\IdempotencyManager $instance */
            return $instance->isLocked($key, $scope);
        }
         ...
         * @static
         */
        public static function forget($key, $scope = null)
        {
            /** @var \Grazulex\ApiIdempotency\IdempotencyManager $instance */
            return $instance->forget($key, $scope);
        }
         ...
         * @static
         */
        public static function resetSkip()
        {
            /** @var \Grazulex\ApiIdempotency\IdempotencyManager $instance */
            return $instance->resetSkip();
        }

        /**
         * Get statistics about stored records.
         *
         * @return \Grazulex\ApiIdempotency\array{total: int, hits: int, size: int}
         * @static
         */
         ...
         * @static
         */
        public static function list($limit = 20)
        {
            /** @var \Grazulex\ApiIdempotency\IdempotencyManager $instance */
            return $instance->list($limit);
        }
         ...
         * @static
         */
        public static function recordReplay($key, $scope = null)
        {
            /** @var \Grazulex\ApiIdempotency\Testing\IdempotencyFake $instance */
            return $instance->recordReplay($key, $scope);
        }
         ...
         * @static
         */
        public static function assertStored($key, $scope = null)
        {
            /** @var \Grazulex\ApiIdempotency\Testing\IdempotencyFake $instance */
            return $instance->assertStored($key, $scope);
        }
         ...
         * @static
         */
        public static function assertNotStored($key, $scope = null)
        {
            /** @var \Grazulex\ApiIdempotency\Testing\IdempotencyFake $instance */
            return $instance->assertNotStored($key, $scope);
        }
         ...
         * @static
         */
        public static function assertReplayed($key, $scope = null)
        {
            /** @var \Grazulex\ApiIdempotency\Testing\IdempotencyFake $instance */
            return $instance->assertReplayed($key, $scope);
        }
         ...
         * @static
         */
        public static function assertNotReplayed($key, $scope = null)
        {
            /** @var \Grazulex\ApiIdempotency\Testing\IdempotencyFake $instance */
            return $instance->assertNotReplayed($key, $scope);
        }
         ...
         * @static
         */
        public static function assertStoredCount($count)
        {
            /** @var \Grazulex\ApiIdempotency\Testing\IdempotencyFake $instance */
            return $instance->assertStoredCount($count);
        }
         ...
         * @static
         */
        public static function assertNothingStored()
        {
            /** @var \Grazulex\ApiIdempotency\Testing\IdempotencyFake $instance */
            return $instance->assertNothingStored();
        }
         ...
         * @static
         */
        public static function assertStoredWithStatus($key, $statusCode, $scope = null)
        {
            /** @var \Grazulex\ApiIdempotency\Testing\IdempotencyFake $instance */
            return $instance->assertStoredWithStatus($key, $statusCode, $scope);
        }
...
namespace Grazulex\ThrottleSmart\Facades {
    ...
    class ThrottleSmart {
         ...
         * @static
         */
        public static function getLimits($user = null)
        {
            /** @var \Grazulex\ThrottleSmart\ThrottleSmartManager $instance */
            return $instance->getLimits($user);
        }
         ...
         * @static
         */
        public static function getRemaining($user, $type = 'minute')
        {
            /** @var \Grazulex\ThrottleSmart\ThrottleSmartManager $instance */
            return $instance->getRemaining($user, $type);
        }
         ...
         * @static
         */
        public static function getQuota($user = null)
        {
            /** @var \Grazulex\ThrottleSmart\ThrottleSmartManager $instance */
            return $instance->getQuota($user);
        }
         ...
         * @static
         */
        public static function consume($cost = 1)
        {
            /** @var \Grazulex\ThrottleSmart\ThrottleSmartManager $instance */
            return $instance->consume($cost);
        }
         ...
         * @static
         */
        public static function resetQuota($user)
        {
            /** @var \Grazulex\ThrottleSmart\ThrottleSmartManager $instance */
            return $instance->resetQuota($user);
        }
         ...
         * @static
         */
        public static function addQuota($user, $amount, $reason = null)
        {
            /** @var \Grazulex\ThrottleSmart\ThrottleSmartManager $instance */
            return $instance->addQuota($user, $amount, $reason);
        }
         ...
         * @static
         */
        public static function setTemporaryLimit($user, $type, $limit, $until)
        {
            /** @var \Grazulex\ThrottleSmart\ThrottleSmartManager $instance */
            return $instance->setTemporaryLimit($user, $type, $limit, $until);
        }
         ...
         * @static
         */
        public static function wouldLimit($request)
        {
            /** @var \Grazulex\ThrottleSmart\ThrottleSmartManager $instance */
            return $instance->wouldLimit($request);
        }
         ...
         * @static
         */
        public static function isBypassed($request)
        {
            /** @var \Grazulex\ThrottleSmart\ThrottleSmartManager $instance */
            return $instance->isBypassed($request);
        }
         ...
         * @static
         */
        public static function resolvePlanUsing($callback)
        {
            /** @var \Grazulex\ThrottleSmart\ThrottleSmartManager $instance */
            return $instance->resolvePlanUsing($callback);
        }
         ...
         * @static
         */
        public static function resolveKeyUsing($callback)
        {
            /** @var \Grazulex\ThrottleSmart\ThrottleSmartManager $instance */
            return $instance->resolveKeyUsing($callback);
        }
         ...
         * @static
         */
        public static function setLimitFor($user, $type, $limit)
        {
            /** @var \Grazulex\ThrottleSmart\Testing\ThrottleSmartFake $instance */
            return $instance->setLimitFor($user, $type, $limit);
        }
         ...
         * @static
         */
        public static function exhaustLimit($user, $type)
        {
            /** @var \Grazulex\ThrottleSmart\Testing\ThrottleSmartFake $instance */
            return $instance->exhaustLimit($user, $type);
        }
         ...
         * @static
         */
        public static function setQuotaUsed($user, $type, $used)
        {
            /** @var \Grazulex\ThrottleSmart\Testing\ThrottleSmartFake $instance */
            return $instance->setQuotaUsed($user, $type, $used);
        }

        /**
         * @static
         */
        public static function assertLimited($user)
        {
            /** @var \Grazulex\ThrottleSmart\Testing\ThrottleSmartFake $instance */
            return $instance->assertLimited($user);
        }

        /**
         * @static
         */
        public static function assertNotLimited($user)
        {
            /** @var \Grazulex\ThrottleSmart\Testing\ThrottleSmartFake $instance */
            return $instance->assertNotLimited($user);
        }

        /**
         * @static
         */
        public static function assertLimitedBy($user, $type)
        {
            /** @var \Grazulex\ThrottleSmart\Testing\ThrottleSmartFake $instance */
            return $instance->assertLimitedBy($user, $type);
        }

        /**
         * @static
         */
        public static function assertQuotaConsumed($user, $expected)
        {
            /** @var \Grazulex\ThrottleSmart\Testing\ThrottleSmartFake $instance */
            return $instance->assertQuotaConsumed($user, $expected);
        }

        /**
         * @static
         */
        public static function assertQuotaRemaining($user, $type, $expected)
        {
            /** @var \Grazulex\ThrottleSmart\Testing\ThrottleSmartFake $instance */
            return $instance->assertQuotaRemaining($user, $type, $expected);
        }
...
namespace  {
    ...
    class Idempotency extends \Grazulex\ApiIdempotency\Facades\Idempotency {}
    class ThrottleSmart extends \Grazulex\ThrottleSmart\Facades\ThrottleSmart {}
}
