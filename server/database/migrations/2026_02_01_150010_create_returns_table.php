...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('returns', function (Blueprint $table): void {
            ...
            $table->enum('return_type', array_column(ReturnTypeEnum::cases(), 'value'));
            $table->enum('status', array_column(ReturnStatusEnum::cases(), 'value'))->default(ReturnStatusEnum::Pending->value);
