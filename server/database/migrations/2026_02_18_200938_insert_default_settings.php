...
return new class extends Migration
{
    public function up(): void
    {
        $settings = [
            ...
            // ── Mail ────────────────────────────────────────────────────────
            ['group' => 'mail', 'key' => 'mail_driver',         'label' => 'Mail Driver',                  'type' => 'string',    'value' => 'smtp',                         'description' => 'Transport driver: smtp, ses, mailgun, postmark, log.',                                                        'is_public' => false],
            ['group' => 'mail', 'key' => 'mail_host',           'label' => 'SMTP Host',                    'type' => 'string',    'value' => 'mailpit',                     'description' => 'SMTP server hostname.',                                                                                        'is_public' => false],
            ['group' => 'mail', 'key' => 'mail_port',           'label' => 'SMTP Port',                    'type' => 'integer',   'value' => '1025',                        'description' => 'SMTP server port (usually 587 or 465).',                                                                      'is_public' => false],
            ['group' => 'mail', 'key' => 'mail_encryption',     'label' => 'Encryption',                   'type' => 'string',    'value' => null,                          'description' => 'Connection encryption: tls, ssl, or leave empty.',                                                            'is_public' => false],
