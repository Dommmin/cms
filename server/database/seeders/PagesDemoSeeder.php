...
HTML;
    ...
    private function seedModulePages(): void
    {
        ...
        $this->updatePage('shop', [
            ...
            'page_type' => 'module',
            'module_name' => 'product_listing',
            'system_page_key' => 'product_listing',
        ...
        $this->updatePage('categories', [
            ...
            'page_type' => 'module',
            'module_name' => 'category_listing',
            'system_page_key' => 'category_listing',
            'module_config' => ['per_page' => 12],
            'is_published' => true,
            'published_at' => now(),
            'position' => 60,
        ...
        $this->updatePage('brands', [
            ...
            'page_type' => 'module',
            'module_name' => 'brand_listing',
            'system_page_key' => 'brand_listing',
