...
import { $createLayoutContainerNode, LayoutContainerNode } from '../../nodes/LayoutContainerNode';
import { $createLayoutItemNode, LayoutItemNode } from '../../nodes/LayoutItemNode';
...
export default function LayoutPlugin(): JSX.Element | null {
    ...
    useEffect(() => {
        if (!editor.hasNodes([LayoutContainerNode, LayoutItemNode])) {
            throw new Error('LayoutPlugin: LayoutContainerNode/LayoutItemNode not registered');
        }
