...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Edit Synonym', href: '' },
];

export default function EditSynonym({ synonym }: { synonym: SearchSynonym }) {
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Edit Search Synonym" />
            <Wrapper>
                <PageHeader
                    title="Edit Synonym"
                    description={`Editing synonym group for "${synonym.term}".`}
                >
                    <PageHeaderActions>
                ...
                <Form
                    action={SearchSynonymController.update.url(synonym.id)}
                    method="put"
                        ...
                        <>
                            ...
                            <div className="grid gap-2">
                                ...
                                <Textarea
                                    ...
                                    name="synonyms_text"
                                    rows={4}
                                    defaultValue={synonym.synonyms.join('\n')}
                                    placeholder={
                            ...
                            <Button type="submit" disabled={processing}>
                                {processing ? 'Saving...' : 'Update Synonym'}
                            </Button>
                        </>
                    )}
                </Form>
