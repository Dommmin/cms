        ...
        products: promotion.products.reduce(
            (acc, product) => {
                acc[product.id.toString()] = {
                    discount_value: product.pivot.discount_value?.toString() || '',
                    discount_type: product.pivot.discount_type || promotion.type,
                };
                return acc;
            },
            {} as Record<string, { discount_value: string; discount_type: string }>,
        ),
        categories: promotion.categories.reduce(
            (acc, category) => {
                acc[category.id.toString()] = {
                    discount_value: category.pivot.discount_value?.toString() || '',
                    discount_type: category.pivot.discount_type || promotion.type,
                };
                return acc;
            },
            {} as Record<string, { discount_value: string; discount_type: string }>,
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <Wrapper>
                <PageHeader
                    ...
                    description={`Modyfikuj ustawienia promocji: ${promotion.name}`}
                >
                    <PageHeaderActions>
