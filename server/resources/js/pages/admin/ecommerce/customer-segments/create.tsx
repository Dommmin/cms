...
import type { SegmentRule } from './form.types';
...
const formId = 'segment-create-form';
...
export default function Create() {
    ...
    function submit(e: React.FormEvent) {
        e.preventDefault();
        post(CustomerSegmentController.store.url());
    }
            ...
            <Wrapper>
                ...
                >
                    ...
                    <StickyFormActions
                        ...
                        submitLabel={__('action.create', 'Create Segment')}
                    />
                </form>
            </Wrapper>
        </AppLayout>
