...
Route::prefix('v1')->name('api.v1.')->group(function (): void {
    ...
    Route::middleware('throttle:api.public')->group(function (): void {
        ...
        Route::prefix('products')->name('products.')->group(function (): void {
            ...
            Route::post('variants/{variant}/subscribe', [ProductController::class, 'subscribeStock'])->name('variants.subscribe-stock');
        ...
        Route::get('orders/track', [OrderController::class, 'trackGuest'])->middleware('throttle:api.strict')->name('orders.track-guest');
