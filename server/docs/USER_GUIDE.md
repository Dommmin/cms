...
- **Cards / Canvas views** — use **Cards** for the full structured editor, or **Canvas** to see visual previews of common hero, rich text, gallery, product, marketing, pricing, FAQ/tabs, stats, alert, testimonial, newsletter, and promotional blocks directly in the page flow. In Canvas, click a block to select it, double-click it or use **Edit** to open the inspector, and edit simple text such as titles, subtitles, descriptions, and CTA labels directly on the preview.
