...
- **Page Builder** — drag-and-drop blocks, sections, reusable blocks, draft/publish versioning, live preview, mobile preview, undo/redo, copy/paste blocks
  ...
  - **Inspector + Responsive Preview Panel** — sticky right panel in the admin builder with Inspector/Preview tabs; Inspector edits the active section/block, Preview has desktop/tablet/mobile iframe toggles, manual refresh/open actions, and stale/current status tied to unsaved changes and save/autosave refreshes
