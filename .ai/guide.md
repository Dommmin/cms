...
- **Page Builder** — drag-and-drop blocks, sections, reusable blocks, draft/publish versioning, live preview, mobile preview, undo/redo, copy/paste blocks
  ...
  - **Responsive Preview Panel** — sticky right iframe preview in the admin builder with desktop/tablet/mobile viewport toggles, manual refresh/open actions, and stale/current status tied to unsaved changes and save/autosave refreshes
